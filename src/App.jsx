...
const styles = {
  ...
  logContainer: { width: '100%', backgroundColor: 'rgba(255, 255, 255, 0.4)', padding: '10px', borderRadius: '15px', border: '1px solid #D2B48C', marginTop: '15px', boxSizing: 'border-box', maxHeight: '150px',overflowY: 'auto' , WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none'},
